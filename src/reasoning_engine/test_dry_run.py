"""
Test case with DRY_RUN enabled to verify character-aware modifications.
"""
...
# Enable DRY_RUN before importing
os.environ["DRY_RUN"] = "True"

# Now import after setting environment
import reasoning_engine.config as config
...
if "evidence_rationale" in result and result["evidence_rationale"]:
    ...
    for idx, rationale_item in enumerate(result["evidence_rationale"], 1):
        ...
        print(f"Character: {rationale_item.get('character', 'N/A')}")
